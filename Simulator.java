...
public class Simulator {
    ...
    public static final double timeStep = 0.1d;
    public static void main(String[] argv) {
	totalTransform = Matrix.identity(4);
	Display displ = new Display(512, 512, 256, 256, 10000.0d * (1.0d / Simulator.SCALING), new Universe(), 2.5d);
	...
	try {
		...
		System.out.println(shft);
		System.out.println("totalTransorm:");
...
class Universe {
	...
	vehicles.add(new Vehicle(40763));
    }
}
class KeyHandler implements KeyListener {
	...
	case 'w':
	    Simulator.totalTransform = Transformations.boostYInv.transform(Simulator.totalTransform);
	    break;
	case 's':
	    Simulator.totalTransform = Transformations.boostY.transform(Simulator.totalTransform);
	    break;
	/*
	case 'a':
	...
	*/
	case 'e':
	    Simulator.totalTransform = Transformations.rotateClock.transform(Simulator.totalTransform);
	    break;
	case 'q':
	    Simulator.totalTransform = Transformations.rotateCounterClock.transform(Simulator.totalTransform);
	    break;
	}
    }
